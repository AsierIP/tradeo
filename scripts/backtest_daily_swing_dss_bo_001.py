#!/usr/bin/env python3
"""Run DSS-004B DSS-BO-001 cache-only Daily Swing backtest."""
...
from tradeo.modules.daily_swing.dss_004b import BacktestConfig, run_dss_bo_001_backtest
...
def main() -> int:
    ...
    if args.cost_mode != "x1,x2,x3":
        raise SystemExit("only --cost-mode x1,x2,x3 is supported for DSS-004B")
    result = run_dss_bo_001_backtest(
        BacktestConfig(
