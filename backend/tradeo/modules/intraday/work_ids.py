...
class IntradayWorkDescriptor:
    ...
    The descriptor is intentionally small and deterministic. Anything that can
    change the answer must be represented here or inside params_hash /
    data_manifest_hash, otherwise two workers could analyze a logically
    different chart under the same fingerprint.
    """
