...
def run_dss_bo_001_backtest(config: BacktestConfig) -> dict[str, Any]:
    ...
    decision_payload = {"schema_version": DSS_004B_SCHEMA_VERSION, "generated_at": utc_now(), "decision": decision, "pattern_id": "DSS-BO-001", "research_pass": decision == "DSS_BO_001_RESEARCH_PASS", "next_phase": "DSS-005 paper_probe signal preview only" if decision == "DSS_BO_001_RESEARCH_PASS" else "review Director criteria", "safety": safety}
