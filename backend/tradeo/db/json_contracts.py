...
_CONTRACTS: tuple[JsonContract, ...] = (
    ...
    JsonContract("intraday_work_items", "payload_json", 1, _FreeformDict),
    JsonContract("intraday_work_items", "result_json", 1, _FreeformDict),
    JsonContract("intraday_work_items", "reason_codes_json", 1, _StringList),
    JsonContract("intraday_worker_heartbeats", "metadata_json", 1, _FreeformDict),
