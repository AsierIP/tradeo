...
```bash
python3 research/audit_bridge/export_audit_package.py --audit-id TRADEO-AUDIT-20260611-213558_daily_internal
```
...
```bash
python3 research/audit_bridge/validate_audit_package.py research/audit_bridge/requests/TRADEO-AUDIT-20260611-213558_daily_internal
```

## Ejecutar Director gate antes del validator estricto

```bash
python3 research/audit_bridge/director_gate.py research/audit_bridge/requests/TRADEO-AUDIT-20260611-213558_daily_internal   --json-output research/audit_bridge/requests/TRADEO-AUDIT-20260611-213558_daily_internal/director_gate_result.json   --markdown-output research/audit_bridge/requests/TRADEO-AUDIT-20260611-213558_daily_internal/director_gate_result.md   --allow-blocked-exit-zero
```
