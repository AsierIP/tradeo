...
| patterns >= 300 samples | 150 |
| patterns >= 500 samples | 112 |
...
| risk | count | notes |
|---|---:|---|
| possible duplicated event rows | 205 | Counted from repeated `duplicate_group_id`. |
...
| likely_duplicates | 205 | Deduplicate or explain before ranking. |
