...
- Fuente de paper trades: `paper_trades.csv` exporta 2 filas desde Laboratorio cuando existen.
...
- Snapshot: generado 2026-06-10T09:43:48+02:00 desde API local en caliente; el laboratorio continuo puede seguir insertando runs despues del export.
