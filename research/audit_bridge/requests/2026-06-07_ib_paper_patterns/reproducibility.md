...
```bash
python3 research/audit_bridge/export_audit_package.py --audit-id 2026-06-07_ib_paper_patterns
```
...
```bash
python3 research/audit_bridge/validate_audit_package.py research/audit_bridge/requests/2026-06-07_ib_paper_patterns
```
